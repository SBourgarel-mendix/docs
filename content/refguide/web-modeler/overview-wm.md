...
| Publish button | Deploy and run the app. Update your app to deploy the latest changes you made in the Web Modeler. Once deployed, click **View** to view your app in action. For more information, see [Deployment Overview in the Web Modeler](/refguide/web-modeler/deployment-wm). |
